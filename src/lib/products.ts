...
export const PRODUCTS: Product[] = [
  {
    ...
    rankLabel: "全平台可用",
    badge: "桌面 + 手机",
    tagline: "免费套餐可用，AI 流量免流，无日志，支持 Windows / macOS / iOS / Android",
    priceLabel: "有免费套餐 · 可选付费升级（月付14元，年付104元）",
    platforms: ["Windows", "macOS", "iOS", "Android"],
    chinaUsable: "针对受限网络优化，一键直连",
    obfuscation: "支持通用和专有协议，适配复杂网络环境",
    logs: "无日志",
    traffic: "免费套餐每月3GB（ChatGPT / Gemini / Claude AI 站点免计量）；付费套餐不限量",
    devices: "多平台客户端",
    highlights: [
      "全平台",
      "不记日志政策",
  ...
  },
  {
    ...
    caveats: [
      "不支持桌面端",
      "有广告",
      "每次连接只持续30分钟-3小时（初始是30分钟，可通过观看广告延长。流量用的不多的话会持续更长的时间）",
      "不支持种子下载",
      "不支持分流"
    ],
